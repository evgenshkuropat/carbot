...
public class BazosParser extends AbstractJsoupParser implements CarSourceParser {
    ...
    private String extractFuelType(String text) {
        ...
        if (containsAny(source, " enyaq ") || compact.contains("enyaq")) {
            return "ELECTRIC";
        }
    ...
    private String extractBrand(String title, String text) {
        ...
        if (containsAny(titleSource, " infiniti ", " fx35 ", " fx-35 ", " fx37 ", " fx-37 ")) return "INFINITI";
        ...
        if (containsAny(source, " mercedes ", " mercedes-benz ", " mercedes-amg ",
                " mrcedes ", " mrcedes-benz ")) return "MERCEDES";
        if (containsAny(source, " infiniti ", " fx35 ", " fx-35 ", " fx37 ", " fx-37 ")) return "INFINITI";
    ...
    private String extractCarType(String title, String text, String url) {
        ...
        if (containsAny(titleSource, " sportage ", " sorento ", " stonic ")) {
            return "SUV";
        }
        ...
        if (containsAny(titleSource,
                ...
                " e350 bluetec ", " e 350 bluetec ", " e350cdi ", " e 350cdi ", " e 350 cdi ",
                " 200d w124 ", " w124 ",
        ...
        if (containsAny(titleSource, " c220 ", " c 220 ", " c220d ", " c 220d ", " c amg 220d ", " e220 ", " e 220 ", " e220d ", " e 220d ", " e300 ", " e 300 ", " e300cdi ", " e 300 cdi ", " cla ", " cls ")) {
            return "SEDAN";
        }
        ...
        if (containsAny(titleSource, " silverado ", " colorado ")) {
            return "PICKUP";
        }
        ...
        if (containsAny(titleSource, " impala ", " malibu ")) {
            return "SEDAN";
        }

        if (containsAny(titleSource, " galant ")) {
            return "SEDAN";
        }
        ...
        if (containsAny(titleSource,
                ...
                " cr-v ", " cr v ", " crv ", " hr-v ", " hr v ", " hrv ", " rav4 ", " c-hr ", " c-hr,", " c hr ", " ch-r ", " chr ",
                ...
                " grand vitara ", " vitara ", " samurai ", " samuraj ", " sedici ", " yeti ",
                " captiva ", " captivu ", " c-crosser ", " c crosser ", " ccrosser ", " tahoe ", " suburban ", " trailblazer ", " bolt ev ",
                " model y ",
                " xv ", " forester ",
                " mokka ",
                " grandland ",
        ...
        if (containsAny(titleSource,
                ...
                " proace verso ", " proace verso,", " proace city verso ", " proace city verso,",
                ...
                " doblo ", " qubo ", " freemont ", " multipla ", " 500l ", " fiat 500l ", " 500 l ", " fiat 500 l ", " combo ", " vaneo ",
                " active tourer ", " f45 ",
        ...
        if (containsAny(titleSource, " prius plus ", " prius+ ", " prius+, ")
                || (containsAny(titleSource, " prius ")
                && containsAny(titleSource, " 7mist ", " 7 mist ", " 7-mist ", " 7 mistny ", " 7 mistne ",
                " 7mĂ­st ", " 7 mĂ­st "))) {
            return "MINIVAN";
        }
        ...
        if (containsAny(titleSource,
                ...
                " sandero ", " stepway ", " steepway ", " logan ", " scala ", " citigo ", " laguna ",
    ...
    private boolean looksCommercialVehicle(String title, String text, String url) {
        ...
        if (containsAny(titleSource, " vivaro ")
                && containsAny(titleSource, " l2 ", " h1 ", " 3 mista ", " 3 místa ")) {
            return true;
        }
