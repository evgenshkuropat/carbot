...
public class BazosParser extends AbstractJsoupParser implements CarSourceParser {
    ...
    private String extractTransmission(String text) {
        ...
        if (containsAny(source, " shs ", " e-dcs ", " edcs ")) {
            return "AUTOMATIC";
        }
    ...
    private String extractBrand(String title, String text) {
        ...
        if (containsAny(titleSource, " qashqai ", " juke ", " x-trail ", " x trail ", " navara ", " micra ", " leaf ", " primera ", " terrano ", " pixo ")) return "NISSAN";
        ...
        if (containsAny(source, " qashqai ", " juke ", " x-trail ", " x trail ", " navara ", " micra ", " leaf ", " primera ", " terrano ", " pixo ")) return "NISSAN";
    ...
    private String extractCarType(String title, String text, String url) {
        ...
        if (containsAny(titleSource, " yaris cross ", " rav4 ", " rav 4 ", " 4runner ", " 4 runner ")) {
            return "SUV";
        }
