...
public class SbazarParser implements CarSourceParser {
    ...
    private String detectFuelType(String searchable) {
        ...
        if (containsAny(searchable,
                ...
                " t8 ", "recharge", "superb iv", "kodiaq iv",
        ...
        if (containsAny(searchable,
                ...
                "focus 1.0", "focus 1,0", "focus combi 1.6", "focus combi 1,6", "e-thp", "ethp", "htp",
    ...
    private boolean hasElectricSignal(String searchable) {
        return containsAny(searchable,
                ...
                " e-2008 ", " e 2008 ", " id 4 ", "id.4", " id4 ", " id 5 ", "id.5", " id5 ",
                "eq comfort", " smart eq", "ioniq 5", "elektro", "electric", "bev",
    ...
    private boolean hasFuelSignal(String identityText, String fuelType) {
        return switch (fuelType) {
            ...
            case "HYBRID" -> containsAny(identityText, "plug-in", "plugin", "phev", "hybrid", " hev ", " mhev ",
                    ...
                    " t8 ", "recharge", "superb iv", "kodiaq iv", " b5 ",
    ...
    private String detectCarType(String searchable) {
        ...
        if (containsAny(searchable, "touran", "sharan", "alhambra", "altea", "s-max", "c-max", "b-max", "galaxy", "zafira", "scenic", "picasso", "roomster", "berlingo", "rifter", "caddy", "vito", "viano", "v 250", "tridy v", "tridy r", "proace verso", "proace city verso", "multivan", "volkswagen t5", "volkswagen t6", "vw t5", "vw t6", "tourneo custom", "tourneo connect", "u-tour", "u tour", "225xe", "active tourer", " f45 ", "dokker", "lodgy", "jogger", "b180", "b 180", "b200", "b 200", "peugeot 807", " 807 ", "mazda 5", "grandis", "voyager", "pacifica", "grand caravan", "sienna", "ix20", "meriva", "partner tepee", "peugeot partner")) {
            return "MINIVAN";
        }
        ...
        if (containsAny(searchable, "citigo", "rapid", "sandero", " rio ", "swift", "starlet", "mazda 3", "v40", "tridy a", "a 160", "a160", "a 45", "a45", "c3", "fiesta", "a1", "a3", "panda", "bravo", "matiz", "fortwo", "fourtwo", "forfour", "cupra born", "jazz",
                "id.3", " id 3 ", " id3 ",
    ...
    private String resolveCarType(String identityText, String scopedText) {
        ...
        if ("SUV".equals(scopedType)
                && !containsAny(identityText, "suv", "4x4", "kodiaq", "karoq", "yeti", "tiguan", "touareg", "qashqai", "x-trail", "bmw x", "q3", "q5", "q7", "q8", "kuga", "duster", "bayon", "inster", "omoda", "jaecoo", "3008", "5008", "vitara", "crossover")) {
            return "-";
        }
